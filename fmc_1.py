    ...
    for q in queries:
        ...
        if violated == False:
            ...
            if  cav == True and upc == True:
                ...
                if "the question cannot be answered" in answer.lower() or "there is no mention" in answer.lower() or "the provided text does not contain any information" in answer.lower():
                    ...
                    if "the question cannot be answered" not in answer2.lower() and "there is no mention" not in answer2.lower() and "the provided text does not contain any information" not in answer2.lower():
